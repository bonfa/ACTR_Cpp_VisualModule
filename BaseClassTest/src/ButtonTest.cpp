...
void ButtonTest_ParameterCheck_01(){
	...
	ASSERT_EQUAL(expectedText,q->getChunk());
	ASSERT_EQUAL(buttonText,q->getText());
}
...
cute::suite make_suite_ButtonTest(){
	...
	s.push_back(CUTE(ButtonTest_ParameterError_04));
	s.push_back(CUTE(ButtonTest_ParameterError_05));
	return s;
}
